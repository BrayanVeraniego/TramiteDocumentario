--referencia para cCodUsu
CREATE TABLE S01TUSU(
   cCodUsu CHARACTER(4)   NOT NULL UNIQUE
);
...
--referencia para RUC
CREATE TABLE S01MPRV(
   cNroRuc CHARACTER(11)  NOT NULL UNIQUE,
   CDesRuc VARCHAR(400)   NOT NULL
);

CREATE TABLE D02MTRX(
  cCodTrx CHARACTER(6)   NOT NULL UNIQUE
);
